...
// @name           Diablo Quick Links
// @category       Diablo
// @version        6.6.6
// @id             diablo-quick-draw-links-layer@DiabloEnMusica
// @namespace      https://softspot.nl/ingress/
// @depends        diablo-quick-draw-links-layer@DiabloEnMusica
...
`;
	...
	self.settings.drawcolor='#000000';
	self.settings.greatcirclecolor='#e35027b3';
	self.settings.fieldcolor='#0faeaebe';
	self.settings.opacity=0.2;
	self.settings.fillOpacity=0.2;
	self.settings.crosslinkbookmarkcolor='#FFFFFF';
	...
	self.restoresettings=function() {
		if ( typeof localStorage[ self.localstoragesettings ]==='string' ) {
			...
			if ( typeof settings==='object'&&settings instanceof Object ) {
				...
				if ( typeof settings.opacity==='number' ) self.settings.opacity=settings.opacity; // Diablo
				if ( typeof settings.fillOpacity==='number' ) self.settings.fillOpacity=settings.fillOpacity; // Diablo
	...
	*/
		...
		setTimeout( function() { // the sidebar is constructed after firing the hook
			...
			if ( linkcount>0 ) {
				...
				if ( !self.settings.hidebuttons ) {
					$( '#updatestatus' ).prepend( '<a class="quickdrawbutton screenbuttoncopy" accesskey="y" href="#" onclick="'+onclickaction+'"'+titledescription+'><span class="screenbutton screencopyicon" /></a>' );
				}
			...
			if ( true ) {
				...
				if ( !self.settings.hidebuttons ) {
					$( '#updatestatus' ).prepend( '<a class="quickdrawbutton screenbuttonstar" accesskey="s" href="#" onclick="'+onclickaction+'"'+titledescription+'><span class="screenbutton screenstaricon"'+styleactivebutton+' /></a>' );
				}
			...
			if ( linkcount>0 ) {
				...
				if ( !self.settings.hidebuttons ) {
					$( '#updatestatus' ).prepend( '<a class="quickdrawbutton screenbuttonmove" accesskey="." href="#" onclick="'+onclickaction+'"'+titledescription+'><span class="screenbutton screenmoveicon" /></a>' );
				}
			...
			if ( true ) {
				...
				if ( !self.settings.hidebuttons ) {
					$( '#updatestatus' ).prepend( '<a class="quickdrawbutton screenbuttonlink" accesskey="k" href="#" onclick="'+onclickaction+'"'+titledescription+'><span class="screenbutton screenlinkicon"'+styleactivebutton+' /></a>' );
				}
	...
	self.updatefieldslayer=function() {
		if ( !self.layeractive( 'New Quick Draw Fields' ) ) return;
	...
	self.menu=function() {
		...
		$( '#field_color' ).spectrum( $.extend( true, spectrumoptions, {
			change: function( color, opacity, fillOpacity ) { self.settings.fieldcolor=color.toHexString(); self.settings.opacity=opacity.Number(); self.settings.fillOpacity=fillOpacity.Number(); self.storesettings(); self.updatefieldslayer(); },
			color: self.settings.fieldcolor, opacity: self.settings.opacity, fillOpacity: self.settings.fillOpacity
		} ) );
	};
	...
	self.setup=function() {
		...
		window.addLayerGroup( 'New Quick Draw Fields', self.fieldslayer, true );
